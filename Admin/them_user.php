...
<body>
    ...
    ?>
    <form method="post" name="themUser" action="" enctype="multipart/form-data">
        <table align="center" >
            <tr>
                <th colspan="2">THÊM USER MỚI</th>
            </tr>
            ...
            <tr>
                ...
                <td><input type="password" name="password" style="width: 300px; padding: 5px;"></td>
            </tr>
            <tr>
